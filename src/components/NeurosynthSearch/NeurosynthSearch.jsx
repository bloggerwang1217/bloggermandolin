    ...
    <div className="neurosynth-root">
      ...
      <div className="main-layout">
        <aside className="left-panel">
          ...
          {/* Left Suggestions: sibling of the panel to avoid clipping */}
        ...
        <main className="right-panel">
          ...
          {/* Main Suggestions: sibling to prevent clipping */}
          ...
          {/* Operator IME Chooser moved out as sibling */}
          ...
          <div id="resultsSection" className="results-section" style={{ display: 'none' }}>
            ...
            <h3>Results for "<span id="currentQuery"></span>" (<span id="resultCount">0</span> found)</h3>
